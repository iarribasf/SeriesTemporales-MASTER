...
* Los criterios de bondad de ajuste RMSE = 159 y MAPE = 3.7% son prácticamente iguales a los obtenidos para la serie original.
...
Veamos ahora si mejoramos la calidad de ajuste usando el criterio de minimizar el error cuadrático medio para estimar los parámetros del modelo.
...
## Aplicación sobre el módelo identificado
...
## Aplicación a modelos alternativos
...
|**Id**  |**Transformacion** |**Modelo** |**Método estimación** |
|:-------|:------------------|:----------|:---------------------|
...
| 4      |Logartimo          |AAA        |mínimo error en previsiones a 2 periodos vista  |
| 5      |Defuncones por día |MAM        |Máxima verosimilitud  |
| 6      |Defuncones por día |MAM        |mínimo error en previsiones a 2 periodos vista  |
...
* Modelo 3: `ets(x, model = "AAA", lambda = 0, biasadj = TRUE, damped = FALSE)`
* Modelo 4: `ets(x, model = "AAA", lambda = 0, biasadj = TRUE, damped = FALSE,  opt.crit = "amse", nmse = 2)`
