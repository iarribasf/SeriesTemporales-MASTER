...
Recordemos que la serie va de enero de 1980 hasta diciembre de 2018, pero que se ha analizado desde enero de 1988. Se ha ajustado a un alisado exponencial ETS(M,A,M), con un error de predicción intra-muestral a un periodo vista del 3.8%.
...
mapeAlisado1 <- matrix(NA, s, h)
mapeAlisado2 <- matrix(NA, s, h)
mapeAlisado3 <- matrix(NA, s, h)
mapeAlisado4 <- matrix(NA, s, h)
mapeAlisado5 <- matrix(NA, s, h)
mapeAlisado6 <- matrix(NA, s, h)
...
* Globalmente el modelo que ofrece mejores previsiones es el modelo 6, realizado sobre las defunciones media por día y donde el criterio para estimar los parámetros es la minimización del error de las previsiones a dos periodos vista. Este modelo es de los mejores en previsiones a corto y medio plazo y el mejor a largo plazo.
