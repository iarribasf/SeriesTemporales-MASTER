...
* Las dos siguientes líneas eliminan de la serie diaria los festivos y los fines de semana, (función `isBizday`), para después dar a esta nueva serie el formato año-mes eliminando el día. De esta forma, la serie de dias laborales tendrá el mismo identificador para todos los días del mismo mes.

* Después, se crea una tabla que, por la naturaleza de la serie de dias laborales, tendrá para cada año-mes el numero de días laborables. Por último fechamos la tabla, que es nuestra serie de días laborables y mostramos algunos datos.
