...
* En cada mes, __la tasa de variación anual de los nacimientos es la misma que la del mes pasado__ ($\widehat{TVAnacimientos}_t = TVAnacimientos_{t-1}$). 
...
```{r}
ggAcf(error, lag = 36, main = "Figura 18. FAC del error del modelo")
Box.test(error, lag = 2,type = "Ljung-Box")
Box.test(error, lag = 24,type = "Ljung-Box")
Box.test(error^2, lag = 2, type = "Ljung-Box")
Box.test(error^2, lag = 24, type = "Ljung-Box")
